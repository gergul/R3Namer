...
public:
	 ...
	 * @note      	
	 */
	BOOL SetItemExCtrl(int nItem, int nSubItem, CWnd *pExCtrl, bool bDelIfExist=true, bool bDelOnListDestory=true, bool bRefresh = true);
...
//设置主题样式
// 如果不设置，则在 HDN_ENDTRACKW 事件中使用GetSubItemRect获得的是旧的尺寸
#if defined _M_IX86
